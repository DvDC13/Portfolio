...
Command: npx gltfjsx@6.5.2 public/models/react_logo.glb 
  ...
  return (
    <Float floatIntensity={1}>
      <group position={[8, 8, 0]} {...props} scale={0.3} dispose={null}>
        <mesh geometry={nodes['React-Logo_Material002_0'].geometry} material={materials['Material.002']} position={[0, 0.079, 0.181]} rotation={[0, 0, -Math.PI / 2]} scale={[0.39, 0.39, 0.5]} />
      </group>
    </Float>
  )
}
